        ...
        if white_turn:
            for position, piece in white_pieces.items():
                ...
                while current_move:
                    ...
                    yield new_black_pieces, Board.makeMove(white_pieces, position, current_move), new_heuristic
                    current_move = next(all_moves_of_piece)
        else:
            for position, piece in black_pieces.items():
                ...
                while current_move:
                    ...
                    yield Board.makeMove(black_pieces, position, current_move), new_white_pieces, new_heuristic
                    current_move = next(all_moves_of_piece)
        yield None
        ...
        for position, piece in white_pieces.items():
            ...
            while current_move:
                ...
                if current_move in black_pieces:
                    ...
                    new_black_pieces.pop(current_move)
                yield new_black_pieces, Board.makeMove(white_pieces, position, current_move), new_heuristic, ((piece.x(), piece.y()),current_move)
                current_move = next(all_moves_of_piece)
        yield None
