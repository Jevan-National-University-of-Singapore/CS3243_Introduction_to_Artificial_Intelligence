...
##  3. Functions:                                #T_FNC                                             ##
##      - search(): does the DFS                                                                    ##
##      - run_DFS(): parse the file and initialise the state and environment                        ##
##  =============================================================================================   ##
##  4. Main     #T_MAIN                                                                             ##
##                                                                                                  ##
######################################################################################################
...
class Node:
    ...
    def getPath(self, visited_nodes):    # returns the testcase format for move   ## -> List[[(str, int), (str, int)]]
        current_node = self
        path = [self.getMove()]
...
##========================== FUNCTIONS START ===========================   
def search(start, board, goals):    #dfs algorithm
    ...
    while stack:                                            #algo start
        current_position = stack.pop()     #get a frontier node
