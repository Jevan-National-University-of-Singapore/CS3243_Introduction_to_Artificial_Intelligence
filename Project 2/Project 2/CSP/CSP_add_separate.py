...
class Board:
    ...
    def __hash__(self):
        return hash(self._enemy_pieces)
    ...
    def addPiece(self, added_piece) -> bool:
        self._enemy_pieces = self._enemy_pieces.union({added_piece})
        self._invalid_positions.add(added_piece.position())


    def addThreats(self, added_threats) -> bool:
...
def search(rows, columns, pieces, obstacles):    #Hill climbing algorithm
    ...
    start = Board(rows, columns, frozenset(), obstacles)
                    ...
                    if successor not in visited:
                        ...
                        for piece in current_pieces:
                            if piece.position() in current_piece_threat:
                                ...
                                break
                        if not violated:
                            successor.addThreats(current_piece_threat)
