...
class Board:
    def __init__(self, rows, columns, pieces, obstacles):
        ...
        self._pieces: list = [] #list of strings representing position of each obstacle ## -> List[str]
        self._blocked = set()
        ...
        for piece in pieces:
            self._pieces.append(Piece.create(piece[0], piece[1], self))
    ...
    def getSuccessor(self, i):
        ...
        successor.removePiece(i)
        successor.updateHeuristic()
        return successor
...
def search(rows, columns, pieces, obstacles, k):    #bfs algorithm
    ...
    while priority_queue:
        ...
        number_of_pieces = len(state.pieces())
